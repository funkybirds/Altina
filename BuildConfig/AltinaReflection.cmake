...
function(ae_add_reflection_codegen)
    ...
    # Visual Studio/MSBuild generators do not reliably produce compile_commands.json. Since the
    # reflection scanner consumes a compilation database, fall back to a stub implementation
    # when it is missing so the engine and demos can still build.
    if (NOT EXISTS "${compile_commands_root}/compile_commands.json")
        message(WARNING
