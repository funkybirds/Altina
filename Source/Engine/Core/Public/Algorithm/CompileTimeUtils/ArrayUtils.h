...
namespace AltinaEngine::Core::Algorithm
{
    ...
    template <typename T, unsigned N> consteval auto GetOccurrencePosition(TArray<T, N> const& str, T c, u64 o) -> u64
    {
    ...
    template <typename T, unsigned N> consteval auto GetLastOccurrencePosition(TArray<T, N> const& str, T c) -> u64
    {
        u64 pos = 0;
        for (u64 i = 0; i < str.Size(); ++i)
        {
