...
// Platform detection macros (0 or 1)
    ...
    #define AE_PLATFORM_WIN 1
#else
    #define AE_PLATFORM_WIN 0
#endif

#if defined(__APPLE__) && defined(__MACH__)
    #define AE_PLATFORM_MACOS 1
#else
    #define AE_PLATFORM_MACOS 0
#endif

#if defined(__ANDROID__)
    #define AE_PLATFORM_ANDROID 1
#else
    #define AE_PLATFORM_ANDROID 0
#endif

#if defined(__linux__) && !defined(__ANDROID__)
    #define AE_PLATFORM_LINUX 1
#else
    #define AE_PLATFORM_LINUX 0
#endif
