...
namespace AltinaEngine::Core::Container
{
    ...
    public:
        ...
        R        operator()(Args... args) { return vtable->Invoke(&storage, AltinaEngine::Forward<Args>(args)...); }
    ...
    private:
        ...
        struct StorageT
        {
            alignas(SmallAlign) unsigned char data[SmallSize];
        };
        ...
        template <typename F> static void DestroyImpl(void* storage) noexcept { reinterpret_cast<F*>(storage)->~F(); }
        ...
        template <typename F> static R InvokeImpl(void* storage, Args... args)
        {
