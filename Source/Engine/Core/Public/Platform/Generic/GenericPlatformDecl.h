...
namespace AltinaEngine::Core::Platform::Generic {
    ...
    AE_CORE_API auto PlatformSleepConditionVariableCS(
        void* CV, void* CS, unsigned long Milliseconds) -> int;
    ...
    AE_CORE_API auto PlatformInterlockedCompareExchange32(
        volatile i32* ptr, i32 exchange, i32 comparand) -> i32;
    ...
    AE_CORE_API i64  PlatformInterlockedCompareExchange64(
         volatile i64* ptr, i64 exchange, i64 comparand);
