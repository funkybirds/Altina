...
namespace AltinaEngine::Core::Reflection
{
    ...
    public:
        ...
        virtual void WriteString(Container::FStringView value) { WriteBytes(value.Data(), value.Length()); }
    ...
    public:
        ...
        template <CCustomExternalSerializable T> T Read() { return TCustomSerializeRule<T>::Deserialize(*this); }
