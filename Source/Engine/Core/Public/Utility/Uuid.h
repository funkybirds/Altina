...
namespace AltinaEngine {
    ...
    struct AE_CORE_API FUuid {
        ...
        using FBytes = Core::Container::TArray<u8, kByteCount>;
        ...
        [[nodiscard]] static auto TryParse(Core::Container::FStringView text, FUuid& out) noexcept
            -> bool;
#endif
        [[nodiscard]] static auto TryParse(Core::Container::FNativeStringView text, FUuid& out)
            noexcept -> bool;
        ...
        [[nodiscard]] auto ToString() const -> Core::Container::FString;
        [[nodiscard]] auto ToNativeString() const -> Core::Container::FNativeString;
