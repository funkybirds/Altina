...
namespace AltinaEngine::Core::Reflection {
    ...
    namespace Detail {
        ...
        AE_CORE_API void RegisterMethodField(const FMetaMethodInfo& methodMeta,
            FNativeStringView name, TFnMemberFunctionInvoker invoker);
        AE_CORE_API auto ConstructObject(FTypeMetaHash classHash) -> FObject;
        AE_CORE_API auto GetProperty(
            FObject& object, FTypeMetaHash propHash, FTypeMetaHash classHash) -> FObject;
        AE_CORE_API auto InvokeMethod(
            FObject& object, FTypeMetaHash methodHash, TSpan<FObject> args) -> FObject;
