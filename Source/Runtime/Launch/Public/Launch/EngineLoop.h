...
namespace AltinaEngine::Launch {
    ...
    private:
        ...
        f32                                  mRenderInternalScale       = 1.0f;
        u32                                  mWindowLogicalWidth        = 1280U;
        u32                                  mWindowLogicalHeight       = 720U;
        u32                                  mLastLoggedDpi             = 0U;
        f32                                  mLastLoggedDpiScale        = 0.0f;
        u32                                  mLastLoggedLogicalWidth    = 0U;
        u32                                  mLastLoggedLogicalHeight   = 0U;
        u32                                  mLastLoggedPhysicalWidth   = 0U;
        u32                                  mLastLoggedPhysicalHeight  = 0U;
        u32                                  mLastLoggedSwapchainWidth  = 0U;
        u32                                  mLastLoggedSwapchainHeight = 0U;
        u32                                  mLastLoggedInternalWidth   = 0U;
        u32                                  mLastLoggedInternalHeight  = 0U;
