...
static_assert(
    std::is_base_of_v<AltinaEngine::Core::Math::TMatrix<f32, 4U, 4U>, FProjectionMatrixf>);
static_assert(
    std::is_base_of_v<AltinaEngine::Core::Math::TMatrix<f64, 4U, 4U>, FProjectionMatrixd>);
